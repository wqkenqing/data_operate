 ...
 */
public class RowCount implements Tool {
...
class RowCountMapper extends Mapper<LongWritable, Text, Text, Text> {
...
class RowCountReducer extends Reducer<Text, Text, Text, Text> {
