 ...
 */
@Slf4j
public class ExportTest2 implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ToolRunner.run(new ExportTest2(), args);
    }
...
//        FILE_OUTPUT = args[2];
        FILE_ROOT = "/";
        FILE_INPUT = "/Users/wqkenqing/Desktop/文档/工作文档/haikang/ws_hy_all,/Users/wqkenqing/Desktop/文档/工作文档/haikang/hy_all";
        ...
        // 打包运行必须执行的方法
        job.setJarByClass(ExportTest2.class);
        ...
        // 1.2 指定自定义的map类
        job.setMapperClass(ExportTest2Mapper.class);
        ...
        // 2.2 指定自定义reduce类
        job.setReducerClass(ExportTest2Reducer.class);
...
class ExportTest2Mapper extends Mapper<LongWritable, Text, Text, Text> {
...
@Slf4j
class ExportTest2Reducer extends Reducer<Text, Text, Text, Text> {

    MultipleOutputs<Text, Text> outputs;
    String name;

    @Override
    public void setup(Context context) {
        outputs = new MultipleOutputs<>(context);
        name = context.getConfiguration().get("out.file.name");
    }
