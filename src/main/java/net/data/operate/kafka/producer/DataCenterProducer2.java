...
@Slf4j
public class DataCenterProducer2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        DataCenterProducer2.setConf("namenode:9092,datanode1:9092,datanode2:9092");
        String val = "";
        String topic = args[0];
        ...
        while (true) {
            ...
            while (cond <= res) {
                ...
                jobj.put("key3", "val1");
                jobj.put("key4", "val1");
                DataCenterProducer2.produceSend(topic, JSONObject.toJSONString(jobj));
                cond++;
            }
